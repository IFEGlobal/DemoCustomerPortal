    ...
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full">
            <div class="relative flex items-center justify-center h-screen overflow-hidden">
                <video src="{{ URL::to('/images/illustrations/FYI-introglobe_1.mp4') }}" type="video/mp4" autoplay="{true}" loop muted class="absolute z-10 w-auto min-w-full min-h-full max-w-none"></video>
            </div>
        </div>
    </div>
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto h-16" src="{{ asset('/logos/SmartLogisticsPortal_final_logo-01.png') }}" alt="logo" />
                <div class="mt-1">
            ...
            @if(Session::has('notice'))
                <div class="flex p-4 mt-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    ...
                    <div>
                        <span class="font-medium text-center">{{ Session::get('notice') }}</span>
                    </div>
                </div>
            @endif
        </div>
