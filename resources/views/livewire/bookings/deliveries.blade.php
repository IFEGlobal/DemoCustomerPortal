        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6 w-full">
            ...
            <div class="lg:flex lg:items-center lg:justify-between col-span-12">
                <div class="min-w-0 flex-1">
                    <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">All Deliveries</h2>
                    ...
                    <div class="inline-flex mt-2">
                        ...
                        <div class="inline-flex rounded-md bg-white dark:bg-gray-800 shadow-sm mt-2 mr-10" role="group">
                            ...
                            <button x-tooltip.placement.bottom="'Go To Containers'" wire:click="goToContainers()" type="button" class="hover:scale-125 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border-t border-b border-gray-200 rounded-r-md hover:bg-blue-400 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700" >
            ...
            <div class="col-span-12 lg:col-span-9">
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4">
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <div wire:click="$emitTo('bookings.full-deliveries-datatable', 'clearFilters')" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="mt-2 text-sm font-semibold text-gray-500 dark:text-white">All Deliveries</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative group">
                            <div class="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-blue-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                            <div class="relative">
                                <div wire:click="$emitTo('bookings.full-deliveries-datatable', 'setFilter', 'delivery', '3')" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                        <img src="/icons/live-icon.svg" width="80">
                                    </div>

                                    <div class="ml-4">
                                        <h2 class="font-semibold">{{ $activeDeliveries ?? 0 }}</h2>
                    ...
                    <div class="relative group">
                        <div class="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-blue-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                        <div class="relative">
                            <div wire:click="$emitTo('bookings.full-deliveries-datatable', 'setFilter', 'delivery', '1')" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="/icons/ship-port-arrival-icon.svg" class="w-8 h-8">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold">{{ $deliveriesThisWeek ?? 0 }} Deliveries </h2>
                    ...
                    <div class="relative group">
                        <div class="absolute -inset-0.5 bg-gradient-to-r from-red-600 to-blue-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
                        <div class="relative">
                            <div wire:click="$emitTo('bookings.full-deliveries-datatable', 'setFilter', 'updated', '2')" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="/icons/due-to-depart-icon.svg" class="w-8 h-8">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold">{{ $updatedThisWeek ?? 0 }} Updated </h2>
                ...
                <div class="card bg-white h-full p-4 dark:bg-gray-800 shadow-lg">
                    ...
                    <div class="mt-2">
                        <p class="text-xs+ text-center text-gray-500">
                            You Can <strong>Click</strong> on any card to filter the deliveries table.
                        </p>
                    </div>
                    <div class="mt-2">
                        <p class="text-xs+ text-center text-gray-500">
            ...
            <div class="w-full h-full bg-white shadow-lg rounded-xl overflow-hidden dark:bg-gray-800 p-4 mb-1 col-span-12">
                <div class="flex flex-wrap mb-4 p-2">
                    <div class="flex items-center">
                        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">My Deliveries</span>
                    </div>
                </div>
                <livewire:bookings.full-deliveries-datatable />
            </div>
