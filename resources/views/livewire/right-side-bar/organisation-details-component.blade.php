<div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide relative flex h-auto w-auto flex-col overflow-hidden rounded-xl bg-gray-200 dark:gb-gray-800 p-3">
                        <div class="grow text-center">
                            <img src="{{ URL::to('/icons/right-side-user.svg') }}" class="flex-shrink-0 w-6 h-6" aria-hidden="true">
                        </div>
    ...
    <div class="rounded-lg bg-slate-150 px-2.5 py-2 dark:bg-navy-600 mt-2">
        <div class="flex items-center justify-between space-x-1">
            ...
            <img src="{{ URL::to('/icons/credit-card.svg') }}" class="flex-shrink-0 w-4.5 h-4.5" aria-hidden="true">
        </div>
                    ...
                    <div class="h-full flex flex-col justify-between">
                        <div class="flex items-start justify-between space-x-4">
                            ...
                            <div class="inline-flex flex-col items-center justify-center">
                                <img class="h-5" src="{{ URL::to('/logos/SmartLogisticsPortal_final_logo-02.png') }}" alt="image" />
