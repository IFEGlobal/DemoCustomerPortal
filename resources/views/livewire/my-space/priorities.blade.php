        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6 w-full">
            <div class="lg:flex lg:items-center lg:justify-between col-span-12">
                <div class="min-w-0 flex-1">
                    <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight dark:text-white">Priorities Dashboard</h2>
            ...
            <div class="col-span-12 lg:col-span-3">
                <div class="card bg-white h-full p-4 dark:bg-gray-800">
                    ...
                    <div class="mt-4">
                        <p class="font-medium text-gray-900 text-xl text-center text-blue-800 dark:text-white underline">You've Loaded {{ $category ?? '...' }}</p>
                    </div>
                </div>
            </div>
            ...
            @if($category == "Shipments")
                <div id="LiveShipments" class="w-full h-full bg-white shadow-lg rounded-xl overflow-hidden dark:bg-gray-800 p-4 mt-10 ml-1 mb-4 col-span-12">
                    <div class="flex flex-wrap mb-4">
                        <div class="flex items-center">
                            <img src="{{ URL::to('/icons/warning.svg') }}" class="w-5 h-5 ml-1 mr-2">
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Shipments</span>
                        </div>
                    </div>
                    <livewire:my-space.priority-shipments-datatable />
                </div>
            @elseif($category == "Containers")
                <div id="LiveShipments" class="w-full h-full bg-white shadow-lg rounded-xl overflow-hidden dark:bg-gray-800 p-4 mt-10 ml-1 mb-4 col-span-12">
                    ...
                    <livewire:my-space.priority-containers-datatable />
                </div>
            @elseif($category == "Deliveries")
                <div id="LiveShipments" class="w-full h-full bg-white shadow-lg rounded-xl overflow-hidden dark:bg-gray-800 p-4 mt-10 ml-1 mb-4 col-span-12">
                    ...
                    <livewire:my-space.priority-deliveries-datatable />
                </div>
            @elseif($category == "Documents")
                <div id="LiveShipments" class="w-full h-full bg-white shadow-lg rounded-xl overflow-hidden dark:bg-gray-800 p-4 mt-10 ml-1 mb-4 col-span-12">
                    ...
                    <livewire:my-space.priority-documents-datatable />
                </div>
            @endif
        </div>
    </main>
