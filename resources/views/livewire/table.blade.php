<div>
    <div class="border-gray-200 rounded dark:bg-gray-900 mb-2">
        <div class="container flex flex-wrap items-center justify-between">
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button x-data="{}" x-on:click="window.livewire.emit('show', {{ $resource }})" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-l-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                    ...
                    <button type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-amber-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-amber-600 mr-2">
    ...
    <div class="min-w-full overflow-x-auto border rounded-md shadow-sm dark:border-gray-700 mb-2">
        <table class="min-w-full bg-white rounded whitespace-nowrap">
            ...
            <tr class="">
                ...
                @foreach($this->columns() as $column)
                    <th >
                        <div class="py-3 px-6 flex items-center text-xs font-semi-bold text-center text-gray-800 uppercase">
                            {{ $column->label  }}
                        </div>
                    </th>
                @endforeach
