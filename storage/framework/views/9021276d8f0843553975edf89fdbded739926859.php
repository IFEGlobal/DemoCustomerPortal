...
<?php elseif($value > 0): ?>
    <span class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">
        <?php echo e($value); ?> days Later
    </span>
<?php endif; ?>
<?php /**PATH /var/www/html/DemoCustomerPortal/resources/views/datatable/routeDifference.blade.php ENDPATH**/ ?>