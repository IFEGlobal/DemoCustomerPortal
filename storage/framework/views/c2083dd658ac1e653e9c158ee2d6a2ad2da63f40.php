...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base-layout','data' => ['title' => 'Login']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full">
            <div class="relative flex items-center justify-center h-screen overflow-hidden">
                <video src="<?php echo e(URL::to('/images/illustrations/FYI-introglobe_1.mp4')); ?>" type="video/mp4" autoplay="{true}" loop muted class="absolute z-10 w-auto min-w-full min-h-full max-w-none"></video>
            </div>
        </div>
    </div>
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                <img class="mx-auto h-16" src="<?php echo e(asset('/logos/SmartLogisticsPortal_final_logo-01.png')); ?>" alt="logo" />
                <div class="mt-1">
            ...
            <form class="mt-10" action="<?php echo e(route('login')); ?>" method="post">
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(Session::has('notice')): ?>
                <div class="flex p-4 mt-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                    <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                    <span class="sr-only">Notice</span>
                    <div>
                        <span class="font-medium text-center"><?php echo e(Session::get('notice')); ?></span>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/DemoCustomerPortal/resources/views/login.blade.php ENDPATH**/ ?>