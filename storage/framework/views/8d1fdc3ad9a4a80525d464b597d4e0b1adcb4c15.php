    ...
    <div class="header-container relative flex w-full bg-white dark:bg-navy-750 print:hidden">
        ...
        <div class="flex w-full items-center justify-between">
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('user.notification-component', [])->html();
} elseif ($_instance->childHasBeenRendered('ZaG3Rqg')) {
    $componentId = $_instance->getRenderedChildComponentId('ZaG3Rqg');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZaG3Rqg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZaG3Rqg');
} else {
    $response = \Livewire\Livewire::mount('user.notification-component', []);
    $html = $response->html();
    $_instance->logRenderedChild('ZaG3Rqg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('documentation.document-navigation', [])->html();
} elseif ($_instance->childHasBeenRendered('olIzOhm')) {
    $componentId = $_instance->getRenderedChildComponentId('olIzOhm');
    $componentTag = $_instance->getRenderedChildComponentTagName('olIzOhm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('olIzOhm');
} else {
    $response = \Livewire\Livewire::mount('documentation.document-navigation', []);
    $html = $response->html();
    $_instance->logRenderedChild('olIzOhm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /var/www/html/DemoCustomerPortal/resources/views/components/app-partials/header.blade.php ENDPATH**/ ?>