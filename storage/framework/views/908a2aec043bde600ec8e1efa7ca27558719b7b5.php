...
<?php elseif(\Carbon\Carbon::parse($value) >= now()): ?>
    <span class="bg-green-100 text-green-800 text-xs font-bold inline-flex items-center px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">
      ...
      <?php echo e(\Carbon\Carbon::parse($value)->format('D d M y H:i')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/DemoCustomerPortal/resources/views/datatable/datebytimebadge.blade.php ENDPATH**/ ?>