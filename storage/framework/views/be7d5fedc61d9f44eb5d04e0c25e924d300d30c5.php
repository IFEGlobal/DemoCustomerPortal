<div>
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6 w-full">
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4">
                        ...
                        <div class="relative">
                            <div wire:click="goToShipments" class="flex items-start rounded-xl cursor-pointer bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/transportation.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['AllShipments'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <a href="#LiveShipments" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/live-icon.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['LiveShipments'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/average.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['AverageShipmentsMonthly'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <div wire:click="goToContainers" class="flex items-start cursor-pointer rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                ...
                                <div class="ml-4">
                                    <h2 class="font-semibold"> <?php echo e($stats['TotalContainers'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <a href="#LiveContainers" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                ...
                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['LiveContainers'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/shipping.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['TotalCarriersUsed'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <a href="#LiveDeliveries" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/truck.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['TotalLiveDeliveries'] ?? 0); ?></h2>
                    ...
                    <div class="relative group">
                        ...
                        <div class="relative">
                            <a href="#LiveDocuments" class="flex cursor-pointer items-start rounded-xl bg-white p-4 shadow-lg dark:bg-gray-800">
                                <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white">
                                    <img src="<?php echo e(URL::to('/icons/paper.svg')); ?>" width="80">
                                </div>

                                <div class="ml-4">
                                    <h2 class="font-semibold"><?php echo e($stats['LiveDocuments'] ?? 0); ?></h2>
            ...
            <div class="col-span-12 lg:col-span-3">
                <div class="w-full py-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    <div class="flex justify-center">
                        <div class="relative">
                            <img src="<?php echo e(auth()->user()->getAvatar()); ?>" class="rounded-full h-10 w-10">
                        </div>
                    </div>
                    <div class="flex flex-col text-center mt-2 mb-1">
                        <span class="text-lg font-medium">Welcome, <?php echo e(auth()->user()->name); ?></span>
                    </div>
                    <div class="px-10 mb-2 text-center">
                        <span class="bg-gray-100 h-5 p-1 px-3 rounded text-xs cursor-pointer hover:shadow hover:bg-gray-200">Login <?php echo e(\Carbon\Carbon::parse(auth()->user()->last_login_at)?->format('D d M') ?? '-'); ?> at <?php echo e(\Carbon\Carbon::parse(auth()->user()->last_login_at)?->format('h:i A') ?? 'First Login'); ?></span>
                    </div>
                    <div class="flex items-center justify-center mt-2">
                        <button type="button" wire:click="$emit('switch')" class="text-white bg-blue-700 hover:bg-blue-900 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2">
                            ...
                            <?php echo e($currentForwarder ?? 'No Forwarder'); ?>

                        </button>

                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="button" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); this.closest('form').submit();" class="text-white text-xs bg-red-500 hover:bg-red-600 hover:text-white border border-gray-200 font-medium rounded-lg px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
            ...
            <?php if(in_array('CARN001', auth()->user()->access()->pluck('client_code')->toArray())): ?>
                <div id="TimeCritical" class="card col-span-12 lg:col-span-12 p-4">
                    <div class="flex flex-wrap mb-4">
                        <div class="flex items-center">
                            <img src="<?php echo e(URL::to('/icons/live-icon.svg')); ?>" class="w-10 h-10 ml-1 mr-2">
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Time Critical</span>
                        </div>
                    </div>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dashboard.time-critical-datatable', [])->html();
} elseif ($_instance->childHasBeenRendered('l3159246414-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3159246414-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3159246414-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3159246414-0');
} else {
    $response = \Livewire\Livewire::mount('dashboard.time-critical-datatable', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3159246414-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
            ...
            <div id="LiveShipments" class="card col-span-12 lg:col-span-12 p-4">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dashboard.live-shipments-datatable', [])->html();
} elseif ($_instance->childHasBeenRendered('l3159246414-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l3159246414-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3159246414-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3159246414-1');
} else {
    $response = \Livewire\Livewire::mount('dashboard.live-shipments-datatable', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3159246414-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            <div id="LiveContainers" class="card col-span-12 lg:col-span-12 p-4">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dashboard.live-containers-datatable', [])->html();
} elseif ($_instance->childHasBeenRendered('l3159246414-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l3159246414-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3159246414-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3159246414-2');
} else {
    $response = \Livewire\Livewire::mount('dashboard.live-containers-datatable', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3159246414-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            <div id="LiveDeliveries" class="card col-span-12 lg:col-span-12 p-4">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dashboard.live-deliveries-datatable', [])->html();
} elseif ($_instance->childHasBeenRendered('l3159246414-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l3159246414-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3159246414-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3159246414-3');
} else {
    $response = \Livewire\Livewire::mount('dashboard.live-deliveries-datatable', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3159246414-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
            ...
            <div id="LiveDocuments" class="card col-span-12 lg:col-span-12 p-4">
                ...
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('dashboard.live-documents-datatable', [])->html();
} elseif ($_instance->childHasBeenRendered('l3159246414-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l3159246414-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3159246414-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3159246414-4');
} else {
    $response = \Livewire\Livewire::mount('dashboard.live-documents-datatable', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3159246414-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php /**PATH /var/www/html/DemoCustomerPortal/resources/views/livewire/dashboard/dashboard.blade.php ENDPATH**/ ?>