...
class ViewDeliveriesDatatable extends DataTableComponent
{
    use WireToast;
    ...
    public function mount(string $containerId): void {}

    public function builder(): Builder
    {
        return ContainerDelivery::query()->where('container_id', $this->containerId);
    }
    ...
    public function exportSelected()
    {
        ...
        else
        {
            ...
            if(count($deliveries))
            {
                ...
                return Excel::download(new CardClickExport($this->GetDeliveryHeadersAndData($deliveries)), 'ContainerDeliveryTableExport.xlsx');
            }
            else
            {
                toast()->warning('No records where selected from the table','Warning')->push();
